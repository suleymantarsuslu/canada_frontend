...
useEffect(() => {
  ...
  const handleAddGuest = () => {
    ...
    setModalAction(() => async () => {
      try {
        await axios.post('https://api.canada-ankara.com/api/admin/guests', newGuest, {
          headers: { Authorization: `Bearer ${localStorage.getItem('token')}` },
        });
  ...
  const handleUpdateGuest = () => {
    ...
    setModalAction(() => async () => {
      try {
        ...
        await axios.put(`https://api.canada-ankara.com/api/admin/guests/${editGuest._id}`, payload, {
          headers: { Authorization: `Bearer ${localStorage.getItem('token')}` },
        });
  ...
  const handleDelete = (id) => {
    ...
    setModalAction(() => async () => {
      try {
        await axios.delete(`https://api.canada-ankara.com/api/admin/guests/${id}`, {
          headers: { Authorization: `Bearer ${localStorage.getItem('token')}` },
        });
        fetchGuests(currentPage, searchTerm);
        fetchTotalGuests();
  ...
  const handleToggleAttend = (id) => {
    ...
    setModalAction(() => async () => {
      try {
        await axios.put(`https://api.canada-ankara.com/api/admin/guests/${id}/toggle-attend`, {}, {
          headers: { Authorization: `Bearer ${localStorage.getItem('token')}` },
        });
        setModalOpen(false);
        fetchGuests(currentPage, searchTerm);
      ...
      try {
        if (plusOneQrId && plusOneQrId !== 'NA') {
          try {
            ...
            if (plusOneGuest) {
              await axios.delete(`https://api.canada-ankara.com/api/admin/guests/${plusOneGuest._id}`, {
                headers: { Authorization: `Bearer ${localStorage.getItem('token')}` },
              });
        ...
        await axios.put(
          `https://api.canada-ankara.com/api/admin/guests/${guestId}`,
          { plusOneQrId: '' },
          { headers: { Authorization: `Bearer ${localStorage.getItem('token')}` } }
        );
...
const inviterOptions = inviters.map((inviter) => {
  ...
  const handleSendMail = async (e) => {
    ...
    try {
      const response = await axios.post(
        'https://api.canada-ankara.com/api/admin/mail/send',
        mailData,
        { 
          headers: { 
  ...
  const handleSendBulkMail = async () => {
    ...
    try {
      const response = await axios.post(
        'https://api.canada-ankara.com/api/admin/mail/bulk',
        {
  ...
  const handleSendMailToSelected = async () => {
    ...
    try {
      const response = await axios.post(
        'https://api.canada-ankara.com/api/admin/mail/send-to-guests',
        {
